...
export const PlayerRelatedQuestions = {
    ...
    activeAgesAtClub: (playerName: string) => `Which were the active years at the club for the ${playerName} ?`,
...
export const AttributeRelatedQuestions = {
    ...
    positions: (positions: number[]) => `Who among these players played in the following ${positions}?`,
    ...
    assists: (assists: number) => `Who among these players has${assists} assits?`,
...
export const ComparisonRelatedQuestions = {
    ...
    assists: () => "Who among these players has the most assits?",
